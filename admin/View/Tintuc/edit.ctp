        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Tintuc.name',array('value'=> $edit_vie['Tintuc']['name'],'class'=>'text-input medium-input','maxlength' => '250','id' => 'idtitle'));?></td>
                </tr>
				 <tr>
                    <td width="145" class="label">Tiêu đề (Tiếng Anh):</td>
                    <td><?php echo $this->Form->input('Tintuc.name_eg',array('value'=> $edit_vie['Tintuc']['name_eg'],'class'=>'text-input medium-input','maxlength' => '250','id' => 'idtitle'));?></td>
                </tr>
               <tr>
           ...
           <tr>
                    ...
                    <td>
						...
						<?php
                            ...
                            $initialValue = $edit_vie['Tintuc']['shortdes_eg'];
                            echo $CKEditor->editor("data[Tintuc][shortdes_eg]", $initialValue, "");
                        ?>
						</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit_vie['Tintuc']['content_eg'];
                            echo $CKEditor->editor("data[Tintuc][content_eg]", $initialValue, "");
                        ?></td>
                </tr>
                <tr>
