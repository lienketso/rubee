        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
             ...
             <tr>
                    ...
                    <td><?php echo $this->Form->input('Post.name_eg',array('label'=>'','class'=>'text-input medium-input','maxlength' => '250','onchange' => 'get_alias()','id' => 'idtitle'));?></td>
                </tr>
                <tr>
...
CKFinder::SetupCKEditor( $CKEditor ) ;
                            $initialValue = '';
                            echo $CKEditor->editor("data[Post][shortdes_eg]", $initialValue, "compact");
                        ?></td>
                </tr>
              <tr>
                ...
                <tr>
                    <td class="label">Nội dung (Tiếng Việt)</td>
                    <td>
