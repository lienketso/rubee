<?php echo $this->Form->create(null, array('url' => DOMAINAD . 'modules/add', 'type' => 'post', 'name' => 'image')); ?>
<div id="khung">
    <div id="main">
        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Module.name', array('label' => '', 'class' => 'text-input medium-input', 'id' => '')); ?></td>
               	</tr>
                <tr>
