    ...
    <div id="main">
        <div class="toolbar-list" id="toolbar">
            <ul>
                ...
                <li id="toolbar-unpublish"> <a href="<?php echo DOMAINAD; ?>tins" class="toolbar"> <span class="icon-32-unpublish"></span> Đóng </a> </li>
            </ul>
            <div class="clr"></div>
        </div>
            ...
            <table width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><img src="<?php echo IMAGEAD; ?>tins/<?php echo $value['Tin']['images']; ?>" height="100"></td>
                            <td><a href="<?php echo DOMAINAD ?>tins/edit/<?php echo $value['Tin']['id']; ?>" title="Edit"><?php echo $value['Tin']['name']; ?></a> <?php if(date('Y-m-d', strtotime($value['Tin']['modified'])) == date('Y-m-d')) { ?><img src="<?php echo DOMAINAD ?>images/icons/iconnew.gif" alt="New" /><?php } ?></td>
                            ...
                            <td>
                                <label><input type="radio" name="sphot[<?php echo $value['Tin']['id']; ?>]" value="1" id="sphot_0" <?php if($value['Tin']['hot'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="sphot[<?php echo $value['Tin']['id']; ?>]" type="radio" id="sphot_1" value="0" <?php if($value['Tin']['hot'] == 0) {echo 'checked';} ?>>  Không</label></td>
                            ...
                            <td><a href="<?php echo DOMAINAD ?>tins/edit/<?php echo $value['Tin']['id']; ?>" title="Edit"><img src="<?php echo DOMAINAD ?>images/icons/pencil.png" alt="Edit" /></a> <a href="javascript:confirmDelete('<?php echo DOMAINAD ?>tins/delete/<?php echo $value['Tin']['id']; ?>')" title="Delete"><img src="<?php echo DOMAINAD ?>images/icons/cross.png" alt="Delete" /></a>
                                <?php
                                    if ($value['Tin']['status'] == 0) {
                                        ?>
                                <a href="<?php echo DOMAINAD ?>tins/active/<?php echo $value['Tin']['id']; ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD ?>images/icons/Play-icon.png" alt="Kích hoạt" /></a>
                                <?php
                                    } else {
                                        ?>
                                <a href="<?php echo DOMAINAD ?>tins/close/<?php echo $value['Tin']['id']; ?>" title="Đóng" class="icon-4 info-tooltip"><img src="<?php echo DOMAINAD ?>images/icons/success-icon.png" alt="Ngắt kích hoạt" /></a>
                                <?php
                                    }
                                    ?></td>
