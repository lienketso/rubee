    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
           ...
           <tr>
                    ...
                    <td><?php echo $this->Form->input('News.name_eg',array('value'=> $edit_vie['News']['name_eg'],'class'=>'text-input medium-input','maxlength' => '250','id' => 'idtitle'));?></td>
                </tr>
				<tr>
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('News.pos', array('label' => '', 'class' => 'text-input medium-input', 'maxlength' => '5', 'style' => 'width:200px !important')); ?></td>
                </tr>
                <tr>
                    <td class="label">&nbsp;</td>
                    <td>
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td><?php
                            ...
                            $initialValue = $edit_vie['News']['shortdes_eg'];
                ...
                <tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit_vie['News']['content_eg'];
				...
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit_vie['News']['mota'];
                ...
                <tr>
                    ...
                    <td>
                        <select id="tag_relation" multiple="multiple" onchange="getRalation()" style="height: 180px; width: 51%;">
                            ...
                            <?php } } ?> -->
                            <?php if (count($tags_product)): ?>
                            <?php foreach ($tags_product as $key => $item_tags_product): ?>
                                    <option value="<?= $key ?>" <?= ($item_tags_product['status'] == 1) ? 'selected="selected"' : '' ?>> <?= $item_tags_product['name'] ?></option>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
                    </td>
                ...
                <tr>
                    <td class="label"></td>
                    <td><input type="hidden" id="tag_hidden" placeholder="" name="data[news_tag][tag_id]" value="<?php echo$tags_hidden; ?>"></td>
                    <script type="text/javascript">
