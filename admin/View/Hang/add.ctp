<?php echo $this->Form->create(null, array('url' => DOMAINAD . 'Hang/add' . "/" . $catId, 'type' => 'post', 'name' => 'adminForm', 'enctype'=>'multipart/form-data')); ?>
<div id="khung">
    <div id="main">
        ...
        <div class="tab-content default-tab" id="tab1">
            <table class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Hang.name',array('class'=>'text-input medium-input','maxlength' => '250','onchange' => 'get_alias()','id' => 'idtitle'));?></td>
                </tr>
				  ...
				  <tr>
                    ...
                    <td>
                     <input type="text" size="50" style="height:25px;"  name="userfile" readonly="true"> &nbsp;<a href="javascript:window.open('<?php echo DOMAINAD; ?>upload_noresize.php','userfile','width=500,height=300');window.history.go(1)" ><input type="button" value="Chọn ảnh" class="button" /></a>
				...
				<tr> <td colspan="2"> Chọn các danh mục
				  <div style="overflow:hidden; border:1px solid;">
					  ...
					  <?php foreach($catproduct as $k=>$v) {?>
                          <tr>
                             ...
                             <td><input type="checkbox" name="cat_<?php echo $k?>" /> </td>
                          </tr>
						  
						  <?php $con1=$this->requestAction('hang/get_catproduct/'.$k);
						  foreach($con1 as $k1=>$v1) {
						  ?>
						  <tr>
                             <td style="padding-left:10px;"><label style="color:blue"><?php echo $v1?></label></td>
                             <td style="padding-left:10px;"><input type="checkbox" name="cat_<?php echo $k1?>" /> </td>
                          </tr>
						  
						   <?php $con2=$this->requestAction('hang/get_catproduct/'.$k1);
						  foreach($con2 as $k2=>$v2) {
						  ?>
						  <tr>
                             <td style="padding-left:10px;"><label><?php echo $v2?></label></td>
                             <td style="padding-left:10px;"><input type="checkbox" name="cat_<?php echo $k2?>" /> </td>
                          </tr>
				 ...
				 <tr>
                    ...
                    <td><?php echo $this->Form->input('Hang.pos', array('class' => 'text-input', 'maxlength' => '4')); ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="radio" value="0" id="Hangtatus0" name="data[Hang][status]">
                        Chưa Active 
                        &nbsp;&nbsp;&nbsp;
                        <input type="radio" checked="checked" value="1" id="Hangtatus1" name="data[Hang][status]">
                        Đã Active </td>
                </tr>
            </table>
            <div class="clear"></div>
