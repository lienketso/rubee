				...
				<tr>
                	...
                	<td>
                        <?php
                            ...
                            $initialValue = $edit['Setting']['map'];
                            echo $CKEditor->editor("data[Setting][map]", $initialValue, "");
                        ?>
                    </td>
               	</tr>
				<tr>
                	...
                	<td>
						...
						<?php
                            ...
                            $initialValue = $edit['Setting']['chuchay'];
                            echo $CKEditor->editor("data[Setting][chuchay]", $initialValue, "");
                        ?>
                    </td>
               	</tr>
				<tr>
                	<td class="label">Footer (Tiếng Anh)</td>
                	<td>
						...
						<?php
                            ...
                            $initialValue = $edit['Setting']['chuchay_eg'];
                            echo $CKEditor->editor("data[Setting][chuchay_eg]", $initialValue, "");
                        ?>
                    </td>
               	</tr>
				<tr>
                	<td class="label">Tải hồ sơ năng lực</td>
                	<td>
						...
						<?php
                            ...
                            $initialValue = $edit['Setting']['download'];
                            echo $CKEditor->editor("data[Setting][download]", $initialValue, "");
                        ?>
                    </td>
               	</tr>
                <tr>
