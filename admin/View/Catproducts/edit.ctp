    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            <table class="input">
               ...
               <tr>
                    <td width="120" class="label">Tiêu đề (Tiếng Anh):</td>
                    <td><?php echo $this->Form->input('Catproduct.name_eg', array('value' => $edit_vie['Catproduct']['name_eg'], 'class'=>'text-input medium-input', 'maxlength' => '250', 'id' => 'idtitle')); ?></td>
                </tr>
				  <tr>
				...
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit_vie['Catproduct']['shortdes'];
                            echo $CKEditor->editor("data[Catproduct][shortdes]", $initialValue, "");
                        ?></td>
                </tr>
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit_vie['Catproduct']['shortdes_eg'];
                            echo $CKEditor->editor("data[Catproduct][shortdes_eg]", $initialValue, "");
                        ?></td>
                </tr>
                <tr>
