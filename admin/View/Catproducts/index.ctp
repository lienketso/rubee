...
<div class="content-box">
    ...
    <div class="content-box-content">
            ...
            <table>
                <thead>
                    <tr>
						...
						<th width="8%" nowrap><a href="#" onclick="changepos()">Show trang chủ</a></th>
                        <th>Cập nhật</th>
                        <th>Xử lý</th>
                        <th>Hiển thị</th>
                        <th width="3%">ID</th>
		...
		<td>
                                <label><input type="radio" name="setoff[<?php echo $value['Catproduct']['id']; ?>]" value="1" id="setoff_0" <?php if($value['Catproduct']['setoff'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="setoff[<?php echo $value['Catproduct']['id']; ?>]" type="radio" id="setoff_1" value="0" <?php if($value['Catproduct']['setoff'] == 0) {echo 'checked';} ?>>  Không</label></td>
                    ...
                    <td><?php
                                    if ($value['Catproduct']['status'] == 0) {
                                        ?>
                                <a href="<?php echo DOMAINAD ?>catproduct/active/<?php echo $value['Catproduct']['id']; ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD ?>images/icons/Play-icon.png" alt="Kích hoạt" /></a>
                                <?php
                                    } else {
                                        ?>
                                <a href="<?php echo DOMAINAD ?>catproduct/close/<?php echo $value['Catproduct']['id']; ?>" title="Đóng" class="icon-4 info-tooltip"><img src="<?php echo DOMAINAD ?>images/icons/success-icon.png" alt="Ngắt kích hoạt" /></a>
                                <?php
                                    }
                                    ?></td>
