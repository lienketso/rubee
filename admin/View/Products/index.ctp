...
<th width="8%" nowrap><a href="#" onclick="changepos()">SP mới</a></th>
<th width="8%" nowrap><a href="#" onclick="changepos()">SP KM</a></th>
<th width="8%" nowrap><a href="#" onclick="changepos()">SP B.Chạy</a></th>
<th width="8%" nowrap><a href="#" onclick="changepos()">SP Xem nhiều</a></th>-->
<!--<th width="8%" nowrap><a href="#" onclick="changepos()">SP S.Viên</a></th>-->
	 ...
	 <td>
                                <label><input type="radio" name="hot[<?php echo $value['Product']['id']; ?>]" value="1" id="spnb_0" <?php if($value['Product']['hot'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="hot[<?php echo $value['Product']['id']; ?>]" type="radio" id="spnb_1" value="0" <?php if($value['Product']['hot'] == 0) {echo 'checked';} ?>>  Không</label></td>
								                    
				 <td>
                                <label><input type="radio" name="saleoff[<?php echo $value['Product']['id']; ?>]" value="1" id="spnb_0" <?php if($value['Product']['saleoff'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="saleoff[<?php echo $value['Product']['id']; ?>]" type="radio" id="spnb_1" value="0" <?php if($value['Product']['saleoff'] == 0) {echo 'checked';} ?>>  Không</label></td>
								
							
								  <td>
                                <label><input type="radio" name="new[<?php echo $value['Product']['id']; ?>]" value="1" id="spnb_0" <?php if($value['Product']['new'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="new[<?php echo $value['Product']['id']; ?>]" type="radio" id="spnb_1" value="0" <?php if($value['Product']['new'] == 0) {echo 'checked';} ?>>  Không</label></td>
								-->
								<!--  <td>
                                <label><input type="radio" name="spnb[<?php echo $value['Product']['id']; ?>]" value="1" id="spnb_0" <?php if($value['Product']['spnb'] == 1) {echo 'checked';} ?>> Có</label>
                                <label><input name="spnb[<?php echo $value['Product']['id']; ?>]" type="radio" id="spnb_1" value="0" <?php if($value['Product']['spnb'] == 0) {echo 'checked';} ?>>  Không</label></td>-->
