...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
         ...
         <tr>
                    <td width="120" class="label">Tên sản phẩm (Tiếng Anh):</td>
                    <td><?php echo $this->Form->input('Product.name_eg',array('label'=>'','class'=>'text-input medium-input','maxlength' => '60','onchange' => 'get_alias()','id' => 'idtitle'));?>
			...
			<tr>
               ...
               <tr>
                    ...
                    <td>
                     <input type="text" size="50" style="height:25px;" value="<?php echo $edit['Product']['images']?>"  name="userfile1" readonly="true"> &nbsp;<a href="javascript:window.open('<?php echo DOMAINAD; ?>upload_multi_noresize.php?stt=1','userfile1','width=500,height=300');window.history.go(1)" ><input type="button" value="Chọn ảnh" class="button" /></a>
			   ...
			   <tr>
                    ...
                    <td>
                     <input type="text" size="50" value="<?php echo $edit['Product']['images2']?>" style="height:25px;"  name="userfile2" readonly="true"> &nbsp;<a href="javascript:window.open('<?php echo DOMAINAD; ?>upload_multi_noresize.php?stt=2','userfile2','width=500,height=300');window.history.go(1)" ><input type="button" value="Chọn ảnh" class="button" /></a>
				  ...
				  <tr>
                    ...
                    <td>
                     <input type="text" size="50" value="<?php echo $edit['Product']['images3']?>" style="height:25px;"  name="userfile3" readonly="true"> &nbsp;<a href="javascript:window.open('<?php echo DOMAINAD; ?>upload_multi_noresize.php?stt=3','userfile3','width=500,height=300');window.history.go(1)" ><input type="button" value="Chọn ảnh" class="button" /></a>
			    ...
			    <tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit['Product']['shortdes'];
                            echo $CKEditor->editor("data[Product][shortdes]", $initialValue, "");
                        ?></td>
                </tr>
				 <tr>
                    <td class="label">Mô tả sản phẩm (Tiếng Anh):</td>
                    <td><?php
                            $CKEditor = new CKEditor();
                            $CKEditor->config['width'] = '98%';
                            $CKEditor->config['height'] = '300';
                            ...
                            $initialValue = $edit['Product']['shortdes_eg'];
                            echo $CKEditor->editor("data[Product][shortdes_eg]", $initialValue, "");
                        ?></td>
                </tr>
				<tr>
				...
				<tr>
                    <td class="label">Nội dung sản phẩm (Tiếng Anh):</td>
                    <td><?php
                            $CKEditor = new CKEditor();
                            $CKEditor->config['width'] = '98%';
                            $CKEditor->config['height'] = '300';
                            ...
                            $initialValue = $edit['Product']['content_eg'];
                            echo $CKEditor->editor("data[Product][content_eg]", $initialValue, "");
                        ?></td>
                </tr>
                <tr>
