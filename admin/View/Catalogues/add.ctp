        ...
        <div class="tab-content default-tab" id="tab1">
            <table class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Catalogue.name', array('class'=>'text-input medium-input', 'maxlength' => '250', 'id' => 'idtitle')); ?></td>
                </tr>
			 <tr>
                    <td width="120" class="label">Tên Danh mục (Tiếng Anh):</td>
                    <td><?php echo $this->Form->input('Catalogue.name_eg', array('class'=>'text-input medium-input', 'maxlength' => '250', 'id' => 'idtitle')); ?></td>
                </tr>
                 <tr>
