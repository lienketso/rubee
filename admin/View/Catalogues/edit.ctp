        ...
        <div class="tab-content default-tab" id="tab1">
            <table class="input">
			  ...
			  <tr>
                    ...
                    <td><?php echo $this->Form->input('Catalogue.name_eg', array('value' => $edit_vie['Catalogue']['name_eg'], 'class'=>'text-input medium-input', 'maxlength' => '250', 'id' => 'idtitle')); ?></td>
                </tr>
               <tr>
				...
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit_vie['Catalogue']['shortdes'];
                            echo $CKEditor->editor("data[Catalogue][shortdes]", $initialValue, "");
                        ?></td>
                </tr>
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit_vie['Catalogue']['shortdes_eg'];
                            echo $CKEditor->editor("data[Catalogue][shortdes_eg]", $initialValue, "");
                        ?></td>
                </tr>
                <tr>
