<?php echo $this->Form->create(null, array( 'url' => DOMAINAD . 'doitac/add','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>
<div id="khung">
    <div id="main">
        <div class="toolbar-list" id="toolbar">
            <ul>
                ...
                <li id="toolbar-unpublish"> <a href="<?php echo DOMAINAD; ?>doitac" class="toolbar"> <span class="icon-32-cancel"></span> Hủy </a> </li>
            </ul>
            <div class="clr"></div>
        </div>
        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                <tr>
                	...
                	<td><?php echo $this->Form->input('Doitac.name',array('label' => '', 'class'=>'text-input medium-input', 'id' => 'idtitle', 'onchange' => 'get_alias()'));?></td>
               	</tr>
                <tr>
                    <td class="label">Liên kết tĩnh:</td>
                    <td><?php echo $this->Form->input('Doitac.alias',array('label' => '', 'class'=>'text-input medium-input', 'id' => 'idalias'));?> <img width="16" height="16" alt="" onclick="get_alias();" style="cursor: pointer; vertical-align: middle;" src="<?php echo DOMAINAD; ?>images/refresh.png"></td>
                </tr>
            </table>
            <div class="clear"></div>
        </div>
