            ...
            <table width="100%" class="input">
				...
				<!-- <tr>
                	...
                	<td>
                		<select name="data[Slideshow][display]" id="data[][]">
                			<option <?php if($edit['Slideshow']['display']==1) echo 'selected="selected"';?> value="1">Slide con</option>
                			<option <?php if($edit['Slideshow']['display']==2) echo 'selected="selected"';?> value="2">Trang chủ</option>
				...
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit['Slideshow']['shortdes'];
                            echo $CKEditor->editor("data[Slideshow][shortdes]", $initialValue, "");
                        ?></td>
                </tr>
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit['Slideshow']['shortdes_eg'];
                            echo $CKEditor->editor("data[Slideshow][shortdes_eg]", $initialValue, "");
                        ?></td>
                </tr>
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit['Slideshow']['content'];
				...
				<tr>
                    ...
                    <td><?php
                            ...
                            $initialValue = $edit['Slideshow']['content_eg'];
