...
$query = "SELECT * FROM products where cat_id =285 order by id LIMIT 20 ";
...
<rss version="2.0">
	<channel>
		<title>Thiết kế biển quảng cáo | Rubee.com.vn</title>
		<link>http://rubee.com.vn/ds-sp/285/thiet-ke-bien-quang-cao.html</link>
		<url>
			<posts/>
			<index/>
			<rss/>
		</url>
		<description>Thiết kế bản hiệu quảng cáo cho doanh nghiệp, biển quảng cáo công ty với thiết kế chuyên nghiệp, thi công nhanh chóng.</description>
