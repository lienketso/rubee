...
<div class="title_top_news_detail" style="margin-top:7px;margin-bottom: 10px;">
        ...
        <table width="590px" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>
                         <form style="margin-right: 5px;"  id="myform" name="contactForm" class="form_contact"  onsubmit="return validateForm();" method="post" action="<?php echo DOMAIN?>contact/contact">
