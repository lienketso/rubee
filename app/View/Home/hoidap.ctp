...
<div id='center' style="
width: 780px;color:#006738;">
<div>
	<div  style="border: 1px solid #b1a89c;
background: white;
border-radius: 21px;
padding-left: 23px;
padding-top: 20px;"class="t">
	<tr>
		...
		<form id="myform" method="POST" action="<?php echo DOMAIN?>home/addhoidap" onsubmit="return test()">
