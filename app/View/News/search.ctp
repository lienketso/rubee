	                    ...
	                    <div class="sidebar-widget widget_search">	
								<div class="search-form">
									<?php echo $this->Form->create(null, array('url' => DOMAIN . 'tim-kiem-tin.html', 'type' => 'post', 'name' => 'frm1')); 
										$keywords =$this->Session->read('txtsearchnews');
									?>
										<input type="text" placeholder="Tìm kiếm tin tức" value="<?php echo $keywords;?>" id="field2c" name="txtsearch" class="search-input">
							...
							<div class="post-entry" style="margin-bottom: 30px;">	
								...
								<div class="widget-post-thumb" style="width:150px; height:110px; position:relative;">
                                    ...
                                    <a href="<?php echo DOMAIN; ?>chi-tiet-tin-tuc/<?php echo $rows['News']['id']; ?>/<?php echo $rows['News']['alias'].'.html'; ?>" class="box_image">
                                    	<img src="<?php echo IMAGEAD?>news/<?php echo $rows['News']['images']?>" alt="<?php echo $rows['News']["name$duoi"]; ?>">
                                    </a>			
								</div>
								<div class="post-entry-title ">
							     ...
							     <div class="post-entry-meta">
									 <img src="<?php echo DOMAIN?>/images/icon/date.png" />  <?php echo $rows['News']["created"]; ?>
                                     <img src="<?php echo DOMAIN?>/images/icon/user.png" style="margin-left:20px"/>  <?php echo $newsAuth['Administrator']['fullname']?>	
