...
<!-- slide -->
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.max(Math.min(parentWidth, 1920), 943));
                else
    ...
    <div id="slider1_container" style="position: relative; top: 75px; width: auto;
        height: 943px; overflow: hidden; margin-left: auto; margin-right: auto; ">
        ...
        <!-- Arrow Left -->
        <span u="arrowleft" class="jssora20l" style="width: 30px; height: 55px; top: 123px; left: 18px;">
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora20r" style="width: 30px; height: 55px; top: 123px; right: 18px">
        </span>
        <!-- Arrow Navigator Skin End -->
        
        <!-- Thumbnail Navigator Skin Begin -->
        <div u="thumbnavigator" class="jssort01" style="position: absolute; width: 1366px; height: 142px; left:200px; bottom: 0px;">
            ...
            <div u="slides" style="cursor: move;">
                <div u="prototype" class="p" style="position: absolute; width: 272px; height: 142px; top: 10px; left: 0px;">
...
<div class="page-container">
					<div class="page-section " >
						<div class="wrap" id="sphome">
                        <div class="duankhac">
						<h2 class="duantitle" style="color: #b3b3b3;">Dự án khác</h2>									
						</div>
				<?php 
				$i=0;
