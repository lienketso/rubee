...
<!--
<link rel="stylesheet" href="<?php echo DOMAIN?>css/base.css">
<link rel="stylesheet" href="<?php echo DOMAIN?>css/style_parallax.css">
<script type="text/javascript" src="<?php echo DOMAIN?>js/parallax.js"></script>
-->

<div class="duanbg">
				
<div class="wrap" id="sphome">
					<h2 class="duantitle">Dự án tiêu biểu: <span><?php echo $detailNews['Tintuc']["name$duoi"] ?></span></h2>
...
<!-- slide -->
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.max(Math.min(parentWidth, 1366), 700));
                else
    ...
    <div id="slider1_container" style="position: relative; top: 75px; width: 1366px;
        height: 600px; overflow: hidden; margin-left: auto; margin-right: auto; ">
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(http://rubee.com.vn/img/loading.gif) no-repeat center center;
                top: 0px; left: 0px;width: 100%;height:100%;">
            </div>
        </div>

        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1366px; height: 500px; overflow: hidden;">
            <?php
                    $str = $detailNews['Tintuc']["shortdes_eg$duoi"];
                    $str2arr = explode(',', $str);
                    ...
                    for ($i = 1; $i < count($str2arr); $i++)
                    {
                        ...
                        ?>  
                        <div>
                        <img u="image" src="<?php echo  $str2arr[$i];?>" />
                        <img u="thumb" src="<?php echo  $str2arr[$i];?>" />
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r, .jssora05ldn, .jssora05rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(http://rubee.com.vn/img/a17.png) no-repeat;
                overflow:hidden;
            }
        ...
        <!-- Arrow Left -->
        <span u="arrowleft" class="jssora20l" style="width: 30px; height: 55px; top: 123px; left: 8px;">
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora20r" style="width: 30px; height: 55px; top: 123px; right: 8px">
        </span>
        <!-- Arrow Navigator Skin End -->
        
        <!-- Thumbnail Navigator Skin Begin -->
        <div u="thumbnavigator" class="jssort01" style="position: absolute; width: 1366px; height: 100px; left:0px; bottom: 0px;">
            ...
            <style>
                ...
                */
                ...
                .jssort01 .p:hover .c, .jssort01 .pav:hover .c, .jssort01 .pav .c {
                    background: url(http://rubee.com.vn/img/t01.png) center center;
                    border-width: 0px;
                    top: 2px;
                    left: 2px;
                    width:340px;
            ...
            <div u="slides" style="cursor: move;">
                <div u="prototype" class="p" style="position: absolute; width: 340px; height: 100px; top: 0; left: 0;">
...
<div class="hotlineduan">
<div class="wrap" id="sphome">
    <a class="hotline" href="#"></a>
    <img src="<?php echo DOMAIN?>/img/imghotline.png" />
</div>
</div>
<!--
<div class="hotlineduan">
...
<div class="page-container">
					<div class="page-section " >
						<div class="wrap" id="sphome">
                        <div class="duankhac">
						<h2 class="duantitle">Dự án khác</h2>									
						</div>
				<?php 
				$i=0;
